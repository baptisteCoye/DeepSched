...
for i in range(nb_epochs):
    ...
    while not_finished(graph):
        ...
        chosen_solution = process_solution(solution)
...
for i in range(nb_test):
    ...
    matrix = distance_matrix(graph)
    matrix_test = distance_matrix(graph_test)
    already_scheduled = numpy.zeros(graph_size)
    ...
    if execution_time_test > execution_time:
        ...
        print("NNNNIIIIIIIIIIIIIIIIQQQQQQQQQQQQQQQUUUUUUUUUUEEEEEEEEEEEEEEEE TTTTTTTTTTTTTTTTTTTOOOOOOOOOOOOOOOOOOIIIIIIIIIIIIII")
        print(execution_time_test - execution_time)
        print(matrix)
    else:
        print(execution_time_test - execution_time)
